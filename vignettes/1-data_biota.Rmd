...
#### Size effect
```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_size_density_fish.jpg")
```

#### Sole
```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_estuary_density_sole.jpg")
```

```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_haline_density_sole.jpg")
```

```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_haline_size_density_sole.jpg")
```

#### Seabass
```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_estuary_density_seabass.jpg")
```

```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_haline_density_seabass.jpg")
```

```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_haline_size_density_seabass.jpg")
```

### Shrimps densities

```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_estuary_density_shrimps.jpg")
```

```{r}
get_shortened_path("results/data_POMET/species_densities/plot_POMET_haline_density_shrimps.jpg")
```
