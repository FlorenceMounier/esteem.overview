...
```{r}
res_metaux_trends <- get_last_trend_info(data = data_metaux_ww, norm = metaux)

writexl::write_xlsx(res_metaux_trends, "../inst/results/data_contam/metals/recent_trends_metals_µg_ww.xlsx")
```
...
```{r}
data_metaux_ww_general_levels_estuary <- data_metaux_ww |> 
  drop_na(periode) |> 
...
data_metaux_ww_general_levels <- data_metaux_ww |> 
  drop_na(periode) |> 
...
writexl::write_xlsx(x = list(data_metaux_ww_general_levels, data_metaux_ww_general_levels_estuary), path = "../inst/results/data_contam/metals/summarised_levels_data_metaux_ww.xlsx")
```
