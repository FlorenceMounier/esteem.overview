---
title: "data_benthos_gironde_2008_zones"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{data_benthos_gironde_2008_zones}
...
data_REBENT <- esteem.overview::data_benthos_REBENT_cleaned |> 
  filter(estuary == "Gironde", YEAR == 2008)
```
...
ggplot() +
  ...
  labs(title = "REBENT macrobenthic fauna: Taxonomic repartition Gironde 2008", 
       x = NULL, 
       y = "Abundance (%)",
...
ggsave(plot = ggplot_REBENT_abundance_taxonomy,
       "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_abundance_taxonomy_gironde_2008_zones.jpg",
...
write_xlsx(abundance_prop_species, "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/abundance_prop_species_gironde_2008_zones.xlsx")
```
...
ggplot_REBENT_abundance_species <- abundance_prop_species_5 |> 
  ...
  labs(title = "REBENT macrobenthic fauna: Species composition Gironde 2008", 
       x = NULL, 
       y = "Abundance (%)",
       fill = "Species")
...
ggsave(plot = ggplot_REBENT_abundance_species, "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_abundance_species_gironde_2008_zones.jpg",height = 10, width = 8)
```
...
ggplot_REBENT_sp_richness <- ggplot(species_richness) +
  ...
  geom_point(size = 3) +
  labs(title = "REBENT macrobenthic fauna - Species richness Gironde 2008", 
       x = NULL, y = "Species richness",
       color = "Estuary")
ggplot_REBENT_sp_richness
ggsave(plot = ggplot_REBENT_sp_richness, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_species_richness_gironde_2008_zones.jpg",
       width = 15, height = 6, units = "cm")
```
...
ggplot_shannon_index <- ggplot(shannon_index) +
  ...
  geom_point() +
  labs(title = "REBENT macrobenthic fauna - Shannon index Gironde 2008", 
       x = NULL, y = "Shannon index",
       color = "Estuary")
ggplot_shannon_index
ggsave(plot = ggplot_shannon_index, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_shannon_index_gironde_2008_zones.jpg",
       width = 15, height = 6, units = "cm")
```
...
ggplot_REBENT_density <- ggplot(data_benthos_ind_m2) +
  ...
  geom_point() +
  labs(title = "REBENT macrobenthic fauna: Density Gironde 2008", 
       x = NULL, 
       y = "Density (mean nb ind/m²)",
       color = "Estuary")

ggsave(plot = ggplot_REBENT_density,
       "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_density_gironde_2008_zones.jpg",
...
## Total surface sampled variability
  ggplot_surface_variability <- ggplot(data = data_species_richness_year) +
    ...
    labs(x = NULL, y = "Total surface sampled (m²)", 
         title = "Rebent macrobenthic fauna: Total surface sampled variability Gironde 2008")
  ggplot_surface_variability
  ggsave(plot = ggplot_surface_variability, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_surface_variability_gironde_2008_zones.jpg",
         width = 15, height = 6, units = "cm")
  ...
  ggplot_surface_richness_correlation <- ggplot(data = data_species_richness_year) +
    ...
    labs(x = "Total surface sampled", y = "Species richness",
         title = "Correlation between yearly total surface sampled and species richness Gironde 2008")
  ggplot_surface_richness_correlation
  ggsave(plot = ggplot_surface_richness_correlation, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_surface_richness_correlation_gironde_2008_zones.jpg",
           width = 15, height = 6, units = "cm")
```
...
ggplot_species_richness_year <- ggplot(data_species_richness_year) +
  ...
  geom_point() +
  labs(title = "REBENT macrobenthic fauna - Species richness per square metre Gironde 2008", 
       x = NULL, y = "Mean number of species per m²",
       color = "Estuary")
ggplot_species_richness_year
ggsave(plot = ggplot_species_richness_year, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_species_richness_squarem_gironde_2008_zones.jpg",
       width = 15, height = 6, units = "cm")
```
...
ambi_index <- data_REBENT |> 
  mutate(species = case_when(
    species == "Nemertes" ~ "Nemertea",
    TRUE ~ species)) |> 
  group_by(haline_zone, tidal, species) |> 
  summarise(count = sum(RESULTAT)) |> 
...
ggplot_ambi_index <- ggplot(ambi_index) +
  aes(x = tidal, y = ambi, color = haline_zone) +
  geom_point() +
  labs(title = "REBENT macrobenthic fauna - AMBI Gironde 2008", 
       x = NULL, y = "AZTI Marine Biotic Index")
ggplot_ambi_index
ggsave(plot = ggplot_ambi_index, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_AMBI_index_gironde_2008_zones.jpg",
       width = 15, height = 6, units = "cm")
```
...
ggplot_EQR_ambi_index <- ggplot(EQR_ambi) +
  aes(x = tidal, y = EQR_ambi, color = haline_zone) +
  geom_point() +
  ...
  labs(title = "REBENT macrobenthic fauna - EQR AMBI Gironde 2020", 
       x = NULL, y = "EQR AZTI Marine Biotic Index") + 
  ylim(0, 1)
ggplot_EQR_ambi_index
ggsave(plot = ggplot_EQR_ambi_index, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_EQR_AMBI_index_gironde_2008_zones.jpg",
       width = 15, height = 6, units = "cm")
```
...
ggplot_BEQI_index <- ggplot(BEQI) +
  aes(x = tidal, y = BEQIFR, color = haline_zone, shape = haline_zone) +
  geom_point(size = 3) +
  geom_hline(yintercept = 0.86) +
  geom_hline(yintercept = 0.67) +
  geom_hline(yintercept = 0.4) +
  geom_hline(yintercept = 0.2) +
  labs(title = "REBENT macrobenthic fauna - BEQI-FR Gironde 2008", 
...
ggplot_BEQI_index
ggsave(plot = ggplot_BEQI_index, filename = "../inst/results/data_benthos/indicators/ggplot_REBENT_gironde_2008_zones/ggplot_REBENT_BEQIFR_index_gironde_2008_zones.jpg",
