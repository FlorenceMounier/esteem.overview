...
```{r}
data_OC_pesticides_ww_levels <- data_OC_pesticides_ww |> 
...
data_OC_pesticides_ww_norm_relative <- res_kruskal_OC_pesticides |> 
  select(ESTUARY, PARAMETRE_LIBELLE, median_1, median_2)

data_OC_pesticides_general_levels <- full_join(data_OC_pesticides_ww_levels, data_OC_pesticides_ww_norm_relative)

writexl::write_xlsx(x = data_OC_pesticides_general_levels, path = "../inst/results/data_contam/OC_pesticides/summarised_levels_data_OC_pesticides_ww.xlsx")
```
