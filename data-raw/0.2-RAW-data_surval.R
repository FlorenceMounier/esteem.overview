...
surval_outputs <- raw_data_surval_outputs |>
  ...
  # Identify estuaries from GPS positions
  esteem.overview::get_estuary_from_gps_position(longitude = longitude, latitude = latitude) |>

  # Identify haline zones from GPS positions
  esteem.overview::get_haline_zone_from_gps_position(longitude = longitude, latitude = latitude) |>
  ...
  esteem.overview::get_info_from_dates(date_variable = DATE) |>
