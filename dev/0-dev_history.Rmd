...
renv::settings$use.cache(FALSE) # Force renv use simple cache

# ------
list.files("C:/Users/fmounier/AppData/Local/R/cache/R/renv", 
           recursive = TRUE, 
           pattern = "00LOCK")
locks <- list.files(
  "C:/Users/fmounier/AppData/Local/R/cache/R/renv",
  recursive = TRUE,
  full.names = TRUE,
  pattern = "00LOCK"
)
...
# ------
build_dirs <- list.files(
  "C:/Users/fmounier/AppData/Local/R/cache/R/renv",
  recursive = TRUE,
  full.names = TRUE,
  pattern = "_build$"
)
unlink(build_dirs, recursive = TRUE, force = TRUE)
# reboot Rstudio Ctrl + Shift + F10
renv::restore()
```
