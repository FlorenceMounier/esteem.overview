---
title: "flat_fct_openstreet_base_map.Rmd"
...
# fct_openstreet_base_map

```{r function-fct_openstreet_base_map}
...
```{r examples-fct_openstreet_base_map}
```

```{r tests-fct_openstreet_base_map}
...
fusen::inflate(flat_file = "dev/flat_fct_openstreet_base_map.Rmd", 
